package com.limpu.hita.theta.ui.message
...
import com.limpu.hita.theta.databinding.MessageItemBinding
...
class MessagesListAdapter(mContext: Context, mBeans: MutableList<Message>) :
    ...
    override fun bindHolder(holder: MHolder, data: Message?, position: Int) {
        ...
        holder.binding.avatar.setOnClickListener {
            ActivityTools.startUserActivity(mContext,data?.userId?:"",holder.binding.avatar)
        }
