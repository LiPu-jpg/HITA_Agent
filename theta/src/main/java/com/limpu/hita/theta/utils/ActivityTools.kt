package com.limpu.hita.theta.utils
...
import com.limpu.hita.theta.ui.comment.reply.CommentReplyActivity
import com.limpu.hita.theta.ui.detail.ArticleDetailActivity
import com.limpu.hita.theta.ui.list.activity.ArticleListActivity
import com.limpu.hita.theta.ui.message.MessagesActivity
import com.limpu.hita.theta.ui.topic.detail.TopicDetailActivity
import com.limpu.hita.theta.ui.topic.search.SearchTopicActivity
import com.limpu.hita.theta.ui.user.activity.UserListActivity
import com.limpu.hita.theta.ui.widgets.PhotoDetailActivity
...
object ActivityTools {
    ...
    fun startUserActivity(context: Context, userId: String, imageView: ImageView? = null) {
        val c = Class.forName("com.limpu.hitax.ui.profile.ProfileActivity")
