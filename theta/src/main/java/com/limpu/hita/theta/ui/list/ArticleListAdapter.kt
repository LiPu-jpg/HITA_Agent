package com.limpu.hita.theta.ui.list
...
import com.limpu.hita.theta.data.model.Article
import com.limpu.hita.theta.data.model.LikeResult
import com.limpu.hita.theta.data.model.VoteResult
import com.limpu.hita.theta.data.source.web.ArticleWebSource
import com.limpu.hita.theta.data.source.web.service.codes
import com.limpu.hita.theta.databinding.ArticleItemBinding
import com.limpu.hita.theta.ui.DirtyArticles
import com.limpu.hita.theta.ui.create.CreateArticleActivity
        ...
        fun bindInfo(data: Article?) {
            ...
            if (!data?.images.isNullOrEmpty()) {
                ...
                if ((data?.images?.size ?: 0) >= 3) {
                    com.limpu.hita.theta.utils.ImageUtils.loadArticleImageInto(
                        mContext,
                        data?.images?.get(2),
                        binding.img3
                    )
