package com.limpu.hita.theta.ui.create
...
import com.limpu.hita.theta.databinding.ActivityCreateArticleBinding
import com.limpu.hita.theta.ui.DirtyArticles
import com.limpu.hita.theta.utils.ActivityTools
import com.limpu.hita.theta.utils.ActivityTools.CHOOSE_TOPIC
import com.limpu.hita.theta.utils.ActivityTools.CHOOSE_TOPIC_RESULT
import com.limpu.hita.theta.utils.ImageUtils
import com.limpu.style.base.BaseActivity
import com.limpu.style.picker.FileProviderUtils
import com.limpu.style.picker.GalleryPicker.RC_CHOOSE_PHOTO
    ...
    override fun initViews() {
        ...
        binding.appbar.addOnOffsetChangedListener(AppBarLayout.OnOffsetChangedListener { appBarLayout, verticalOffset ->
            ...
            binding.title.translationX =
                (binding.toolbar.contentInsetStartWithNavigation + com.limpu.stupiduser.util.ImageUtils.dp2px(
                    getThis(),
                    8f
                )) * (1 - scale)
            ...
            binding.done.translationY =
                com.limpu.stupiduser.util.ImageUtils.dp2px(getThis(), 24f) * (1 - scale)
