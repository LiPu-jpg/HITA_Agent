 ...
 * 圆角的文本框底部弹窗
 */
class DialogAutoEditText : TransparentDialog<DialogAutoEditTextBinding>() {
    /**
     * View绑定区
     */
    ...
    fun setTitle(title: String): DialogAutoEditText {
        init_title = title
        return this
    }
    fun setInitValue(value: String): DialogAutoEditText {
        initValue = value
        return this
    }

    fun setOnConfirmListener(onConfirmListener: OnConfirmListener): DialogAutoEditText {
        this.onConfirmListener = onConfirmListener
        return this
    }

    fun setDataLoader(loader: DataLoader): DialogAutoEditText {
