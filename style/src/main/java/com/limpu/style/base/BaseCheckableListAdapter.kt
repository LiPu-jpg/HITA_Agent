...
abstract class BaseCheckableListAdapter<T, C : RecyclerView.ViewHolder> constructor(mContext: Context, mBeans: MutableList<T>) : BaseListAdapter<T, C>(mContext, mBeans) {
