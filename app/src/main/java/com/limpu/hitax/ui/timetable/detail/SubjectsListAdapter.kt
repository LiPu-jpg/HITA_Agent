...
import com.limpu.hitax.databinding.DynamicSubjectListTitleBinding
import com.limpu.hitax.databinding.DynamicSubjectsItemBinding
import com.limpu.style.base.BaseCheckableListAdapter
import com.limpu.style.base.BaseViewHolder
import com.limpu.hitax.ui.timetable.detail.SubjectsListAdapter.SubjectViewHolder
...
class SubjectsListAdapter(
    ...
    override fun getItemViewType(position: Int): Int {
        if (position == mBeans.size) return VIEW_TYPE_FOOT
        return if (mBeans[position].type == TermSubject.TYPE.TAG) VIEW_TYPE_TITLE else VIEW_TYPE_NORMAL
    }
    ...
    override fun getViewBinding(parent: ViewGroup, viewType: Int): ViewBinding {
        return when (viewType) {
            VIEW_TYPE_NORMAL -> DynamicSubjectsItemBinding.inflate(mInflater, parent, false)
            VIEW_TYPE_TITLE -> DynamicSubjectListTitleBinding.inflate(mInflater, parent, false)
            else -> DynamicSubjectsItemBinding.inflate(mInflater, parent, false)
        }
    }
    ...
    companion object {
        ...
        private const val VIEW_TYPE_FOOT = 3
    }
