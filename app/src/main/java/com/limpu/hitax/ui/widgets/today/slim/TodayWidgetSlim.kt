package com.limpu.hitax.ui.widgets.today.slim
...
class TodayWidgetSlim : AppWidgetProvider() {
    companion object {
        const val EVENT_CLICK2 = "com.limpu.hita.WIDGET_EVENT_CLICK2"
        const val EVENT_EXTRA2 = "com.limpu.hita.EXTRA_ITEM2"
    }
